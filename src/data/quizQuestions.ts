...
export const quizQuestions: QuizQuestion[] = [
  {
    id: 1,
    question:
      "Cạnh tranh giữa các doanh nghiệp trong nền kinh tế thị trường mang lại điều gì?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Cạnh tranh thúc đẩy các doanh nghiệp sáng tạo, đổi mới công nghệ, giúp nâng cao chất lượng sản phẩm và giảm giá thành.",
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      "Khi các doanh nghiệp nhỏ liên kết lại với nhau, họ hợp nhất nguồn lực để tăng sức cạnh tranh và tạo ra một thực thể có sức chi phối thị trường — từ đó hình thành độc quyền tập đoàn (hay còn gọi là liên minh độc quyền).",
  },
  {
    id: 3,
    question:
      "Trong nền kinh tế thị trường, điều gì xảy ra khi một doanh nghiệp độc quyền kiểm soát toàn bộ ngành hàng?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Khi một doanh nghiệp độc quyền chiếm lĩnh thị trường, họ có quyền kiểm soát giá cả và sản lượng, vì không có đối thủ cạnh tranh.",
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      "Các ngành công nghiệp nặng như điện lực, đường sắt, dầu khí thường được nhà nước nắm giữ độc quyền vì yêu cầu vốn đầu tư lớn và tính chất quan trọng của các ngành này.",
  },
  {
    id: 5,
    question:
      "Điều gì xảy ra khi nhà nước can thiệp vào một tổ chức độc quyền?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Khi nhà nước can thiệp vào tổ chức độc quyền, họ có thể điều chỉnh giá cả và các quy định, giúp bảo vệ quyền lợi người tiêu dùng và duy trì sự ổn định của thị trường.",
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      "Cạnh tranh trong nền kinh tế độc quyền có thể dẫn đến sự gia tăng phân hóa giàu nghèo, khi lợi nhuận tập trung vào các tập đoàn lớn.",
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      "Do không có sự cạnh tranh, doanh nghiệp độc quyền ít có động lực để đổi mới và sáng tạo, dẫn đến sản phẩm ít cải tiến.",
  },
  {
    id: 8,
    question:
      "Trong mô hình chủ nghĩa tư bản độc quyền nhà nước, điều gì là đặc trưng?",
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "Chủ nghĩa tư bản độc quyền nhà nước là sự kết hợp giữa nhà nước và các tổ chức độc quyền tư nhân, trong đó nhà nước tham gia điều hành nền kinh tế.",
  },
  {
    id: 9,
    question:
      "Đâu là một tác động tích cực của chủ nghĩa tư bản độc quyền nhà nước?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Chủ nghĩa tư bản độc quyền nhà nước giúp tập trung vốn vào các ngành chiến lược, giúp phát triển các ngành quan trọng như năng lượng, giao thông.",
  },
  {
    id: 10,
    question:
      "Khi một quốc gia chuyển sang chủ nghĩa tư bản độc quyền nhà nước, điều gì thường xảy ra?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Trong chủ nghĩa tư bản độc quyền nhà nước, nhà nước kiểm soát các ngành quan trọng của nền kinh tế, nhằm bảo vệ lợi ích quốc gia và giữ sự ổn định.",
  },
  {
    id: 11,
    ...
    correctAnswer: 3,
    explanation:
      "Không phải tất cả các ngành đều thuộc quyền quản lý của nhà nước, chỉ các ngành then chốt như năng lượng, giao thông, viễn thông là thuộc độc quyền nhà nước.",
  },
  {
    id: 12,
    question:
      "Một tác động tích cực của độc quyền nhà nước đối với nền kinh tế là gì?",
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "Nhà nước có thể đầu tư vào các ngành chiến lược cần thiết cho sự phát triển quốc gia, như năng lượng, giao thông, và công nghệ.",
  },
];
